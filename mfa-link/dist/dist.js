...
var _snComponentsApi = __webpack_require__(17);
...
var BridgeManager = function () {
  ...
  _createClass(BridgeManager, [{
    ...
    key: "getInstalledMfa",
    value: function getInstalledMfa() {
      return this.items[0];
    }
  }, {
    key: "itemForId",
...
var jsSHA = __webpack_require__(18);
...
var Util = function () {
  ...
  _createClass(Util, null, [{
    ...
    value: function generateSecretKey() {
      return this.randomBase32(16);
    }
  }, {
    key: "randomBase32",
    value: function randomBase32(length) {
      var text = "";
...
var QRCodeImpl = __webpack_require__(23);
var ErrorCorrectLevel = __webpack_require__(6);
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(3),r=__webpack_require__(13);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
...
var _InstalledMFA = __webpack_require__(19);

var _InstalledMFA2 = _interopRequireDefault(_InstalledMFA);

var _NewMFA = __webpack_require__(28);

var _NewMFA2 = _interopRequireDefault(_NewMFA);
...
var Home = function (_React$Component) {
  ...
  function Home(props) {
    ...
    _BridgeManager2.default.get().initiateBridge();
    _BridgeManager2.default.get().addUpdateObserver(function () {
      var installed = _BridgeManager2.default.get().getInstalledMfa();
      if (installed) {
        _this.setState({ installedMfa: installed, secret: null });
      } else {
        _this.setState({ installedMfa: installed });
      }
    });
...
var InstalledMFA = function (_React$Component) {
  _inherits(InstalledMFA, _React$Component);

  function InstalledMFA(props) {
    _classCallCheck(this, InstalledMFA);

    var _this = _possibleConstructorReturn(this, (InstalledMFA.__proto__ || Object.getPrototypeOf(InstalledMFA)).call(this, props));

    _this.uninstall = function () {
      _BridgeManager2.default.get().uninstallMfa(_this.props.mfa);
    };

    setInterval(function () {
      var epoch = Math.round(new Date().getTime() / 1000.0);
      var countDown = 30 - epoch % 30;
      if (epoch % 30 == 0) _this.forceUpdate();
    }, 100);
    return _this;
  }

  _createClass(InstalledMFA, [{
    key: 'render',
    value: function render() {
      var secret = this.props.mfa.content.secret;
      var url = _Util2.default.generateQrCodeUrl(secret);
...
var BitByte = __webpack_require__(24);
var RSBlock = __webpack_require__(25);
var BitBuffer = __webpack_require__(26);
var util = __webpack_require__(27);
var Polynomial = __webpack_require__(7);
...
var NewMFA = function (_React$Component) {
  _inherits(NewMFA, _React$Component);

  function NewMFA(props) {
    _classCallCheck(this, NewMFA);

    var _this = _possibleConstructorReturn(this, (NewMFA.__proto__ || Object.getPrototypeOf(NewMFA)).call(this, props));

    _this.install = function () {
      _this.setState({ confirm: true });
    };

    _this.cancelConfirmation = function () {
    ...
    _this.handleKeyInputChange = function (event) {
      _this.setState({ confirmKey: event.target.value.trim() });
    };

    _this.handleTokenInputChange = function (event) {
      _this.setState({ confirmToken: event.target.value.trim() });
    };

    _this.submitConfirmationForm = function (event) {
      event.preventDefault();
      var matchesKey = _this.state.confirmKey == _this.state.secret;
      var matchesToken = _Util2.default.getOtp(_this.state.secret) == _this.state.confirmToken;
    ...
    value: function render() {
      ...
      return [this.state.confirm && _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "a",
            { onClick: this.cancelConfirmation, className: "info" },
            "Cancel"
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            " somewhere safe. If you lose this key, you lose access to your account."
          )
        ),
        _react2.default.createElement(
          "form",
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    "strong",
                    { className: "danger" },
                    "permanently locked out of your Standard Notes account."
                  )
                )
              ),
              _react2.default.createElement(
